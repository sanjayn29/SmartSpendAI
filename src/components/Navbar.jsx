...
const Navbar = ({ user, setUser, handleSignOut }) => {
  ...
  return (
    <>
      ...
      <nav
        className={`fixed top-0 left-0 bottom-0 w-64 bg-emerald-100 border-r border-emerald-300 flex flex-col items-start justify-between h-screen z-50 transition-all duration-500 ease-in-out ${
      ...
      >
        ...
        <div className="w-full pt-6 pb-4 px-4 border-t border-emerald-300">
          ...
          <div className="flex justify-center">
            <div className="h-1 w-16 rounded-full bg-gradient-to-r from-amber-500 to-amber-600 mb-2" />
          </div>
